...
This data, coupled with advances in estimating detailed population genetic models, heighten the need
for more detailed simulations of a wide range of species and evolutionary scenarios.
...
So far \stdpopsim has been limited to well characterized model species 
...
As a result, while the simulations themselves may require considerable computation resources,
the potentially most time-consuming and error-prone part in population genomic simulation is
implementation.
